...
class TodolistsControllerTest < ActionController::TestCase
  ...
  test "should create todolist" do
    assert_difference('Todolist.count') do
      post :create, todolist: { description: @todolist.description, list_id: @todolist.list_id, list_title: @todolist.list_title, num_of_todoitems: @todolist.num_of_todoitems }
    end
  ...
  test "should update todolist" do
    patch :update, id: @todolist, todolist: { description: @todolist.description, list_id: @todolist.list_id, list_title: @todolist.list_title, num_of_todoitems: @todolist.num_of_todoitems }
    assert_redirected_to todolist_path(assigns(:todolist))
  end
